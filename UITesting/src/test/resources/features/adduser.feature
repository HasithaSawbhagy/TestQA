Feature: User Management in HRM System
  ...
  Scenario: Assign Admin Role to a Existing User
    ...
    And I fill in the required fields with role "Admin", status "Enabled", employee name "Ray  Max", username "ray-mad", password "James123#", and confirm password "James123#"
